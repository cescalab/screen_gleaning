...
from config import Config_eyedoctor, Config_securitycode_iph6
from utils import evaluate, LeNet_EMAGE_iph6, data_transform_iph6
...
data_transform = data_transform_iph6

cfg = Config_securitycode_iph6
...
for epoch in tqdm(range(cfg.max_epoch)):
    ...
    if val_acc > val_acc_best:
        ...
        torch.save({
                ...
                'loss': loss,
                }, cfg.ckpt_path + 'secpin_6_best.tar')
...
model.load_state_dict(torch.load(cfg.ckpt_path + 'secpin_6_best.pth', map_location='cuda:0'))
